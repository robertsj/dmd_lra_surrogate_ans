...
\begin{document}
    ...
    \begin{frame}
        \frametitle{LRA Benchmark: aboratorium f{\"u}r Reaktorregelung und Anlagensicherung}       
\begin{itemize}
...
\begin{itemize}
       ...
       \item It ustilizes methods such as Multigroup diffusion, discrete ordinates, MOC.
